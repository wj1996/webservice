 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/G:/workspace1/eclipse-commit/WebService/src/weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/G:/workspace1/eclipse-commit/WebService/src/weather.wsdl");

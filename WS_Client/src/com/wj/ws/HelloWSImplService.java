 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://ws.wj.com/", wsdlLocation = "http://localhost:8989/ws/hellows?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8989/ws/hellows?wsdl");
